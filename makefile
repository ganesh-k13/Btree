...
$(ODIR)/test.o:	test.c 
	$(CC)  -Dt=4096 -g -w -o $(ODIR)/test.o -c test.c

$(ODIR)/Node.o:	$(SRCDIR)/Node.c $(IDIR)/Node.h
	$(CC)  -Dt=4096 -g -w -o $(ODIR)/Node.o -c $(SRCDIR)/Node.c
	
$(ODIR)/Btree.o: $(SRCDIR)/Btree.c $(IDIR)/Btree.h $(ODIR)/Node.o
	$(CC)  -Dt=4096 -g -w -o $(ODIR)/Btree.o  -g $(ODIR)/Node.o -c $(SRCDIR)/Btree.c

$(ODIR)/utils.o: $(SRCDIR)/utils.c $(IDIR)/utils.h $(ODIR)/Node.o
	$(CC)  -Dt=4096 -g -w -o $(ODIR)/utils.o -c $(SRCDIR)/utils.c
